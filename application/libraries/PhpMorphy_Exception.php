...
require_once(PHPMORPHY_DIR . '/phpmorphy/fsa/fsa.php');
require_once(PHPMORPHY_DIR . '/phpmorphy/graminfo/graminfo.php');
require_once(PHPMORPHY_DIR . '/phpmorphy/morphiers.php');
require_once(PHPMORPHY_DIR . '/phpmorphy/gramtab.php');
require_once(PHPMORPHY_DIR . '/phpmorphy/storage.php');
require_once(PHPMORPHY_DIR . '/phpmorphy/source.php');
require_once(PHPMORPHY_DIR . '/phpmorphy/langs_stuff/common.php');
